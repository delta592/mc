...
func checkReplicateResyncStartSyntax(cmd *cli.Command) {
	if cmd.Args().Len() != 1 {
...
func mainReplicateResyncStart(_ context.Context, cmd *cli.Command) error {
	...
	checkReplicateResyncStartSyntax(cmd)
